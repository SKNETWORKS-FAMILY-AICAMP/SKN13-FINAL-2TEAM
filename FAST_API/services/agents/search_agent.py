...
- 여성만: 미니원피스, 미디원피스, 맥시원피스, 미니스커트, 미디스커트, 롱스커트
...
3. 가격: "5만원 이하" → [0, 50000], "10만원 이상" → [100000, 9999999]
4. 브랜드: 나이키, 아디다스, 유니클로, ZARA, H&M 등
5. 상황: 데이트, 면접, 파티, 운동, 여행, 출근, 캐주얼 등
6. 스타일: 캐주얼, 정장, 스포티, 빈티지, 미니멀 등"""
