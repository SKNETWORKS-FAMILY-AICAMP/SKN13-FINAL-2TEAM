...
<table>
  ...
  <tr>
    ...
    <td>Final 프로젝트를 진행하면서 많은 고난과 역경이 있었던 것 같은데 그래도 다 함께 해결해나가면서 많은 것을 배운 것 같아요. 개발적인 부분 뿐만 아니라 팀 프로젝트를 하면서 배운점도 많았고 이렇게 마지막이 빨리 올 줄 몰랐는데 하고자 했던것을 다하기에는 시간이 부족하여 아쉬움이 많이 남지만 그래도 잘 마무리 할 수 있음에 감사합니다🥹 모두 수고 많았어요 :raised_hands:</td>
  </tr>
  <tr>
